      ...
      <Content style={{ padding: "24px" }}>
        ...
        <Card className='mb-4'>
          ...
          <Text>
            ...
            <br />- Nhấn <Text strong>“Phê duyệt”</Text> để mở trang phê duyệt.
            <br />- Kiểm tra và xác nhận khóa bí mật trước khi nhấn{" "}
            <Text strong>“Thông qua”</Text>.
          </Text>
        </Card>

        <Card className='mb-4'>
          <Title level={4}>4. Đăng Xuất</Title>
          <Text>
